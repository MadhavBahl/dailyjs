...
console.log ("Destructuring in function argument: ", greetings3 (studentDetails));

// One Liner
const greetings4 = ({ first_name, last_name, profession, age }) => `Hi, I am ${first_name} ${last_name}. I am a ${profession}. My age is ${age}`;
console.log ("One Liner: ", greetings4 (studentDetails));